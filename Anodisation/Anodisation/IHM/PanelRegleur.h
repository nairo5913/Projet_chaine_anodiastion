...
#ifndef __PANELREGLEUR_H__
#define __PANELREGLEUR_H__
...
/// Class PanelRegleur
///////////////////////////////////////////////////////////////////////////////
class PanelRegleur : public wxPanel 
{
	private:
	...
	public:
		...
		PanelRegleur( wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( -1,-1 ), long style = wxTAB_TRAVERSAL ); 
		~PanelRegleur();
	
};

#endif //__PANELREGLEUR_H__

...
FramePrincipal::FramePrincipal( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	wxBoxSizer* bSizerContenuParametreConnexion;
	bSizerContenuParametreConnexion = new wxBoxSizer( wxHORIZONTAL );
	...
	bSizerContenuParametreConnexion->Add( bSizerParametreConnexion, 2, wxEXPAND, 5 );
	...
	bSizerContenuParametreConnexion->Add( bSizerLogoOzanam, 1, wxALIGN_CENTER_VERTICAL, 5 );
	
	
	sbSizerConnexion->Add( bSizerContenuParametreConnexion, 1, wxEXPAND|wxALIGN_CENTER_HORIZONTAL, 5 );
	...
	m_staticline11 = new wxStaticLine( m_panelChoix, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL );
	bSizerChoixPrincipal->Add( m_staticline11, 0, wxEXPAND|wxBOTTOM, 5 );
	
	wxBoxSizer* bSizerChoix;
	bSizerChoix = new wxBoxSizer( wxHORIZONTAL );
	
	
	bSizerChoix->Add( 0, 0, 2, wxEXPAND, 5 );
	
	m_buttonChoixTrajectoires = new wxButton( m_panelChoix, wxID_ANY, wxT("Gestion Trajectoires"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizerChoix->Add( m_buttonChoixTrajectoires, 1, wxALIGN_CENTER_VERTICAL, 5 );
	
	m_buttonChoixMouvements = new wxButton( m_panelChoix, wxID_ANY, wxT("Gestion Mouvements"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizerChoix->Add( m_buttonChoixMouvements, 1, wxALIGN_CENTER_VERTICAL, 5 );
	
	
	bSizerChoix->Add( 0, 0, 2, wxEXPAND, 5 );
	
	
	bSizerChoixPrincipal->Add( bSizerChoix, 1, wxEXPAND|wxALIGN_CENTER_HORIZONTAL, 5 );
	
	
	m_panelChoix->SetSizer( bSizerChoixPrincipal );
	m_panelChoix->Layout();
	bSizerChoixPrincipal->Fit( m_panelChoix );
	sbSizerConnexion->Add( m_panelChoix, 0, wxEXPAND|wxALL|wxALIGN_CENTER_HORIZONTAL, 5 );
	...
	m_staticTextDisponibiliteBras = new wxStaticText( sbSizerDisponibiliteBras->GetStaticBox(), wxID_ANY, wxT("Veuillez demander la disponibilité du bras."), wxDefaultPosition, wxDefaultSize, 0 );
	...
	wxStaticBoxSizer* sbSizerSelectionMouvementsAfficher;
	sbSizerSelectionMouvementsAfficher = new wxStaticBoxSizer( new wxStaticBox( m_scrolledWindowAffichageMouvements, wxID_ANY, wxT("Sélection du mouvement à afficher") ), wxHORIZONTAL );
	
	sbSizerSelectionMouvementsAfficher->SetMinSize( wxSize( 280,-1 ) ); 
	m_listBoxAffichageMouvements = new wxListBox( sbSizerSelectionMouvementsAfficher->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, NULL, wxLB_SINGLE|wxLB_SORT ); 
	sbSizerSelectionMouvementsAfficher->Add( m_listBoxAffichageMouvements, 1, wxALL|wxEXPAND, 5 );
	
	
	bSizerAfficherMouvements->Add( sbSizerSelectionMouvementsAfficher, 0, wxALL|wxEXPAND, 5 );
	
	wxStaticBoxSizer* sbSizerAfficherMouvements;
	sbSizerAfficherMouvements = new wxStaticBoxSizer( new wxStaticBox( m_scrolledWindowAffichageMouvements, wxID_ANY, wxT("Affichage") ), wxHORIZONTAL );
	
	wxBoxSizer* bSizerAfficherMouvementGauche;
	bSizerAfficherMouvementGauche = new wxBoxSizer( wxVERTICAL );
	
	wxBoxSizer* bSizerNomMouvementAffichage;
	bSizerNomMouvementAffichage = new wxBoxSizer( wxHORIZONTAL );
	
	
	bSizerNomMouvementAffichage->Add( 0, 0, 1, wxEXPAND, 5 );
	
	m_staticTextNomAfficherMouvements = new wxStaticText( sbSizerAfficherMouvements->GetStaticBox(), wxID_ANY, wxT("Nom du mouvement :"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextNomAfficherMouvements->Wrap( -1 );
	bSizerNomMouvementAffichage->Add( m_staticTextNomAfficherMouvements, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_textCtrlNomAfficherMouvements = new wxTextCtrl( sbSizerAfficherMouvements->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_READONLY );
	#ifdef __WXGTK__
	if ( !m_textCtrlNomAfficherMouvements->HasFlag( wxTE_MULTILINE ) )
	{
	m_textCtrlNomAfficherMouvements->SetMaxLength( 100 );
	}
	#else
	m_textCtrlNomAfficherMouvements->SetMaxLength( 100 );
	#endif
	m_textCtrlNomAfficherMouvements->SetMinSize( wxSize( 100,-1 ) );
	
	bSizerNomMouvementAffichage->Add( m_textCtrlNomAfficherMouvements, 1, wxALIGN_CENTER_VERTICAL, 5 );
	
	
	bSizerNomMouvementAffichage->Add( 0, 0, 1, wxEXPAND, 5 );
	
	
	bSizerAfficherMouvementGauche->Add( bSizerNomMouvementAffichage, 1, wxALIGN_CENTER_HORIZONTAL|wxEXPAND, 5 );
	
	wxBoxSizer* bSizerDureeTotalMouvementAfficher;
	bSizerDureeTotalMouvementAfficher = new wxBoxSizer( wxHORIZONTAL );
	
	
	bSizerDureeTotalMouvementAfficher->Add( 0, 0, 1, wxEXPAND, 5 );
	
	m_staticTextDureeHeureAfficherMouvements1 = new wxStaticText( sbSizerAfficherMouvements->GetStaticBox(), wxID_ANY, wxT("Durée :"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextDureeHeureAfficherMouvements1->Wrap( -1 );
	bSizerDureeTotalMouvementAfficher->Add( m_staticTextDureeHeureAfficherMouvements1, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_textCtrlDureeHeureAfficherMouvements = new wxTextCtrl( sbSizerAfficherMouvements->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_READONLY );
	#ifdef __WXGTK__
	if ( !m_textCtrlDureeHeureAfficherMouvements->HasFlag( wxTE_MULTILINE ) )
	{
	m_textCtrlDureeHeureAfficherMouvements->SetMaxLength( 2 );
	}
	#else
	m_textCtrlDureeHeureAfficherMouvements->SetMaxLength( 2 );
	#endif
	...
	bSizerDureeTotalMouvementAfficher->Add( m_textCtrlDureeHeureAfficherMouvements, 1, wxALIGN_CENTER_VERTICAL, 5 );
	
	m_staticTextDureeMinuteAfficherMouvements = new wxStaticText( sbSizerAfficherMouvements->GetStaticBox(), wxID_ANY, wxT(":"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextDureeMinuteAfficherMouvements->Wrap( -1 );
	bSizerDureeTotalMouvementAfficher->Add( m_staticTextDureeMinuteAfficherMouvements, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_textCtrlDureeMinuteAfficherMouvements = new wxTextCtrl( sbSizerAfficherMouvements->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_READONLY );
	#ifdef __WXGTK__
	if ( !m_textCtrlDureeMinuteAfficherMouvements->HasFlag( wxTE_MULTILINE ) )
	{
	m_textCtrlDureeMinuteAfficherMouvements->SetMaxLength( 2 );
	}
	#else
	m_textCtrlDureeMinuteAfficherMouvements->SetMaxLength( 2 );
	#endif
	...
	bSizerDureeTotalMouvementAfficher->Add( m_textCtrlDureeMinuteAfficherMouvements, 1, wxALIGN_CENTER_VERTICAL, 5 );
	
	m_staticTextDureeSecondeAfficherMouvements = new wxStaticText( sbSizerAfficherMouvements->GetStaticBox(), wxID_ANY, wxT(":"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextDureeSecondeAfficherMouvements->Wrap( -1 );
	bSizerDureeTotalMouvementAfficher->Add( m_staticTextDureeSecondeAfficherMouvements, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_textCtrlDureeSecondeAfficherMouvements = new wxTextCtrl( sbSizerAfficherMouvements->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_READONLY );
	#ifdef __WXGTK__
	if ( !m_textCtrlDureeSecondeAfficherMouvements->HasFlag( wxTE_MULTILINE ) )
	{
	m_textCtrlDureeSecondeAfficherMouvements->SetMaxLength( 2 );
	}
	#else
	m_textCtrlDureeSecondeAfficherMouvements->SetMaxLength( 2 );
	#endif
	...
	bSizerDureeTotalMouvementAfficher->Add( m_textCtrlDureeSecondeAfficherMouvements, 1, wxALIGN_CENTER_VERTICAL, 5 );
	
	
	bSizerDureeTotalMouvementAfficher->Add( 0, 0, 1, wxEXPAND, 5 );
	
	
	bSizerAfficherMouvementGauche->Add( bSizerDureeTotalMouvementAfficher, 1, wxALIGN_CENTER_HORIZONTAL|wxEXPAND, 5 );
	
	
	sbSizerAfficherMouvements->Add( bSizerAfficherMouvementGauche, 1, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_staticlineAfficherMouvements = new wxStaticLine( sbSizerAfficherMouvements->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_VERTICAL );
	sbSizerAfficherMouvements->Add( m_staticlineAfficherMouvements, 0, wxEXPAND | wxALL, 5 );
	
	wxBoxSizer* bSizerAfficherMouvementDroite;
	bSizerAfficherMouvementDroite = new wxBoxSizer( wxVERTICAL );
	
	sbSizerCoordonneesAfficherMouvements = new wxStaticBoxSizer( new wxStaticBox( sbSizerAfficherMouvements->GetStaticBox(), wxID_ANY, wxT("Coordonnées") ), wxVERTICAL );
	
	bSizerCoordonneesAfficherMouvements = new wxBoxSizer( wxHORIZONTAL );
	
	
	bSizerCoordonneesAfficherMouvements->Add( 0, 0, 1, wxEXPAND, 5 );
	...
	bSizerCoordonneesAfficherMouvements->Add( m_staticTextxAfficherMouvements, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	...
	bSizerCoordonneesAfficherMouvements->Add( m_textCtrlxAfficherMouvements, 1, wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	...
	bSizerCoordonneesAfficherMouvements->Add( m_staticTextyAfficherMouvements, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizerCoordonneesAfficherMouvements->Add( m_textCtrlyAfficherMouvements, 1, wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	...
	bSizerCoordonneesAfficherMouvements->Add( m_staticTextzAfficherMouvements, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizerCoordonneesAfficherMouvements->Add( m_textCtrlzAfficherMouvements, 1, wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	
	
	bSizerCoordonneesAfficherMouvements->Add( 0, 0, 1, wxEXPAND, 5 );
	
	
	sbSizerCoordonneesAfficherMouvements->Add( bSizerCoordonneesAfficherMouvements, 1, wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALL, 5 );
	
	
	bSizerAfficherMouvementDroite->Add( sbSizerCoordonneesAfficherMouvements, 1, wxALIGN_CENTER_HORIZONTAL|wxEXPAND, 5 );
	
	
	sbSizerAfficherMouvements->Add( bSizerAfficherMouvementDroite, 1, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 5 );
	
	
	bSizerAfficherMouvements->Add( sbSizerAfficherMouvements, 1, wxALL|wxEXPAND, 5 );
	...
	wxStaticBoxSizer* sbSizerModifierMouvement;
	sbSizerModifierMouvement = new wxStaticBoxSizer( new wxStaticBox( m_scrolledWindowModifierMouvements, wxID_ANY, wxT("Affichage") ), wxHORIZONTAL );
	...
	m_staticTextNomModifierMouvements = new wxStaticText( sbSizerModifierMouvement->GetStaticBox(), wxID_ANY, wxT("Nom du mouvement :"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_textCtrlNomModifierMouvements = new wxTextCtrl( sbSizerModifierMouvement->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE );
	#ifdef __WXGTK__
	if ( !m_textCtrlNomModifierMouvements->HasFlag( wxTE_MULTILINE ) )
	{
	m_textCtrlNomModifierMouvements->SetMaxLength( 100 );
	}
	#else
	m_textCtrlNomModifierMouvements->SetMaxLength( 100 );
	#endif
	m_textCtrlNomModifierMouvements->SetMinSize( wxSize( 100,-1 ) );
	
	bSizerNomModifierMouvements->Add( m_textCtrlNomModifierMouvements, 1, wxALIGN_CENTER_VERTICAL, 5 );
	...
	wxBoxSizer* bSizerDureeMouvementModifier;
	bSizerDureeMouvementModifier = new wxBoxSizer( wxHORIZONTAL );
	
	
	bSizerDureeMouvementModifier->Add( 0, 0, 1, wxEXPAND, 5 );
	
	m_staticTextDureeHeureModifierMouvements = new wxStaticText( sbSizerModifierMouvement->GetStaticBox(), wxID_ANY, wxT("Durée :"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextDureeHeureModifierMouvements->Wrap( -1 );
	bSizerDureeMouvementModifier->Add( m_staticTextDureeHeureModifierMouvements, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_textCtrlDureeHeureModifierMouvements = new wxTextCtrl( sbSizerModifierMouvement->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE );
	#ifdef __WXGTK__
	if ( !m_textCtrlDureeHeureModifierMouvements->HasFlag( wxTE_MULTILINE ) )
	{
	m_textCtrlDureeHeureModifierMouvements->SetMaxLength( 2 );
	}
	#else
	m_textCtrlDureeHeureModifierMouvements->SetMaxLength( 2 );
	#endif
	...
	bSizerDureeMouvementModifier->Add( m_textCtrlDureeHeureModifierMouvements, 1, wxALIGN_CENTER_VERTICAL, 5 );
	
	m_staticTextDureeMinuteModifierMouvement = new wxStaticText( sbSizerModifierMouvement->GetStaticBox(), wxID_ANY, wxT(":"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextDureeMinuteModifierMouvement->Wrap( -1 );
	bSizerDureeMouvementModifier->Add( m_staticTextDureeMinuteModifierMouvement, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_textCtrlDureeMinutesModifierMouvements = new wxTextCtrl( sbSizerModifierMouvement->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE );
	#ifdef __WXGTK__
	if ( !m_textCtrlDureeMinutesModifierMouvements->HasFlag( wxTE_MULTILINE ) )
	{
	m_textCtrlDureeMinutesModifierMouvements->SetMaxLength( 2 );
	}
	#else
	m_textCtrlDureeMinutesModifierMouvements->SetMaxLength( 2 );
	#endif
	...
	bSizerDureeMouvementModifier->Add( m_textCtrlDureeMinutesModifierMouvements, 1, wxALIGN_CENTER_VERTICAL, 5 );
	
	m_staticTextDureeSecondeModifierMouvements = new wxStaticText( sbSizerModifierMouvement->GetStaticBox(), wxID_ANY, wxT(":"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextDureeSecondeModifierMouvements->Wrap( -1 );
	bSizerDureeMouvementModifier->Add( m_staticTextDureeSecondeModifierMouvements, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_textCtrlDureeSecondeModifierMouvements = new wxTextCtrl( sbSizerModifierMouvement->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE );
	#ifdef __WXGTK__
	if ( !m_textCtrlDureeSecondeModifierMouvements->HasFlag( wxTE_MULTILINE ) )
	{
	m_textCtrlDureeSecondeModifierMouvements->SetMaxLength( 2 );
	}
	#else
	m_textCtrlDureeSecondeModifierMouvements->SetMaxLength( 2 );
	#endif
	...
	bSizerDureeMouvementModifier->Add( m_textCtrlDureeSecondeModifierMouvements, 1, wxALIGN_CENTER_VERTICAL, 5 );
	
	
	bSizerDureeMouvementModifier->Add( 0, 0, 1, wxEXPAND, 5 );
	
	
	bSizerModifierGaucheMouvements->Add( bSizerDureeMouvementModifier, 1, wxALIGN_CENTER_HORIZONTAL|wxEXPAND, 5 );
	
	
	sbSizerModifierMouvement->Add( bSizerModifierGaucheMouvements, 1, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_staticlineModifierMouvements = new wxStaticLine( sbSizerModifierMouvement->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_VERTICAL );
	sbSizerModifierMouvement->Add( m_staticlineModifierMouvements, 0, wxEXPAND | wxALL, 5 );
	
	wxBoxSizer* bSizerModifierDroiteMouvements;
	bSizerModifierDroiteMouvements = new wxBoxSizer( wxVERTICAL );
	
	sbSizerCoordonneesModifierMouvements = new wxStaticBoxSizer( new wxStaticBox( sbSizerModifierMouvement->GetStaticBox(), wxID_ANY, wxT("Coordonnées") ), wxVERTICAL );
	
	bSizerCoordonneesModifierMouvements = new wxBoxSizer( wxHORIZONTAL );
	
	
	bSizerCoordonneesModifierMouvements->Add( 0, 0, 1, wxEXPAND, 5 );
	...
	bSizerCoordonneesModifierMouvements->Add( m_staticTextxModifierMouvements, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	...
	bSizerCoordonneesModifierMouvements->Add( m_textCtrlxModifierMouvements, 1, wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	...
	bSizerCoordonneesModifierMouvements->Add( m_staticTextyModifierMouvements, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizerCoordonneesModifierMouvements->Add( m_textCtrlyModifierMouvements, 1, wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	...
	bSizerCoordonneesModifierMouvements->Add( m_staticTextzModifierMouvements, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizerCoordonneesModifierMouvements->Add( m_textCtrlzModifierMouvements, 1, wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	
	
	bSizerCoordonneesModifierMouvements->Add( 0, 0, 1, wxEXPAND, 5 );
	
	
	sbSizerCoordonneesModifierMouvements->Add( bSizerCoordonneesModifierMouvements, 1, wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALL, 5 );
	
	
	bSizerModifierDroiteMouvements->Add( sbSizerCoordonneesModifierMouvements, 1, wxALIGN_CENTER_HORIZONTAL|wxEXPAND, 5 );
	
	m_sdbSizerModifierMouvement = new wxStdDialogButtonSizer();
	m_sdbSizerModifierMouvementApply = new wxButton( sbSizerModifierMouvement->GetStaticBox(), wxID_APPLY );
	m_sdbSizerModifierMouvement->AddButton( m_sdbSizerModifierMouvementApply );
	m_sdbSizerModifierMouvementCancel = new wxButton( sbSizerModifierMouvement->GetStaticBox(), wxID_CANCEL );
	m_sdbSizerModifierMouvement->AddButton( m_sdbSizerModifierMouvementCancel );
	m_sdbSizerModifierMouvement->Realize();
	
	bSizerModifierDroiteMouvements->Add( m_sdbSizerModifierMouvement, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5 );
	
	
	sbSizerModifierMouvement->Add( bSizerModifierDroiteMouvements, 1, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 5 );
	
	
	bSizerModifierMouvements->Add( sbSizerModifierMouvement, 1, wxALL|wxEXPAND, 5 );
	...
	wxStaticBoxSizer* sbSizerCreerMouvement;
	sbSizerCreerMouvement = new wxStaticBoxSizer( new wxStaticBox( m_scrolledWindowCreerMouvements, wxID_ANY, wxT("Affichage") ), wxHORIZONTAL );
	
	wxBoxSizer* bSizerCreerGaucheMouvements1;
	bSizerCreerGaucheMouvements1 = new wxBoxSizer( wxVERTICAL );
	...
	m_staticTextNomCreerMouvements = new wxStaticText( sbSizerCreerMouvement->GetStaticBox(), wxID_ANY, wxT("Nom du mouvement :"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextNomCreerMouvements->Wrap( -1 );
	bSizerNomCreerMouvements->Add( m_staticTextNomCreerMouvements, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_textCtrlNomCreerMouvements = new wxTextCtrl( sbSizerCreerMouvement->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE );
	#ifdef __WXGTK__
	if ( !m_textCtrlNomCreerMouvements->HasFlag( wxTE_MULTILINE ) )
	{
	m_textCtrlNomCreerMouvements->SetMaxLength( 100 );
	}
	#else
	m_textCtrlNomCreerMouvements->SetMaxLength( 100 );
	#endif
	m_textCtrlNomCreerMouvements->SetMinSize( wxSize( 100,-1 ) );
	
	bSizerNomCreerMouvements->Add( m_textCtrlNomCreerMouvements, 1, wxALIGN_CENTER_VERTICAL, 5 );
	
	
	bSizerNomCreerMouvements->Add( 0, 0, 1, wxEXPAND, 5 );
	
	
	bSizerCreerGaucheMouvements1->Add( bSizerNomCreerMouvements, 1, wxALIGN_CENTER_HORIZONTAL|wxEXPAND, 5 );
	
	wxBoxSizer* bSizerDureeMouvementCreer;
	bSizerDureeMouvementCreer = new wxBoxSizer( wxHORIZONTAL );
	
	
	bSizerDureeMouvementCreer->Add( 0, 0, 1, wxEXPAND, 5 );
	
	m_staticTextDureeHeureCreerMouvements = new wxStaticText( sbSizerCreerMouvement->GetStaticBox(), wxID_ANY, wxT("Durée :"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextDureeHeureCreerMouvements->Wrap( -1 );
	bSizerDureeMouvementCreer->Add( m_staticTextDureeHeureCreerMouvements, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_textCtrlDureeHeureCreerMouvements = new wxTextCtrl( sbSizerCreerMouvement->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE );
	#ifdef __WXGTK__
	if ( !m_textCtrlDureeHeureCreerMouvements->HasFlag( wxTE_MULTILINE ) )
	{
	m_textCtrlDureeHeureCreerMouvements->SetMaxLength( 2 );
	}
	#else
	m_textCtrlDureeHeureCreerMouvements->SetMaxLength( 2 );
	#endif
	...
	bSizerDureeMouvementCreer->Add( m_textCtrlDureeHeureCreerMouvements, 1, wxALIGN_CENTER_VERTICAL, 5 );
	
	m_staticTextDureeMinuteCreerMouvement = new wxStaticText( sbSizerCreerMouvement->GetStaticBox(), wxID_ANY, wxT(":"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextDureeMinuteCreerMouvement->Wrap( -1 );
	bSizerDureeMouvementCreer->Add( m_staticTextDureeMinuteCreerMouvement, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_textCtrlDureeMinutesCreerMouvements = new wxTextCtrl( sbSizerCreerMouvement->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE );
	#ifdef __WXGTK__
	if ( !m_textCtrlDureeMinutesCreerMouvements->HasFlag( wxTE_MULTILINE ) )
	{
	m_textCtrlDureeMinutesCreerMouvements->SetMaxLength( 2 );
	}
	#else
	m_textCtrlDureeMinutesCreerMouvements->SetMaxLength( 2 );
	#endif
	...
	bSizerDureeMouvementCreer->Add( m_textCtrlDureeMinutesCreerMouvements, 1, wxALIGN_CENTER_VERTICAL, 5 );
	
	m_staticTextDureeSecondeCreerMouvements = new wxStaticText( sbSizerCreerMouvement->GetStaticBox(), wxID_ANY, wxT(":"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextDureeSecondeCreerMouvements->Wrap( -1 );
	bSizerDureeMouvementCreer->Add( m_staticTextDureeSecondeCreerMouvements, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_textCtrlDureeSecondeCreerMouvements = new wxTextCtrl( sbSizerCreerMouvement->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE );
	#ifdef __WXGTK__
	if ( !m_textCtrlDureeSecondeCreerMouvements->HasFlag( wxTE_MULTILINE ) )
	{
	m_textCtrlDureeSecondeCreerMouvements->SetMaxLength( 2 );
	}
	#else
	m_textCtrlDureeSecondeCreerMouvements->SetMaxLength( 2 );
	#endif
	...
	bSizerDureeMouvementCreer->Add( m_textCtrlDureeSecondeCreerMouvements, 1, wxALIGN_CENTER_VERTICAL, 5 );
	
	
	bSizerDureeMouvementCreer->Add( 0, 0, 1, wxEXPAND, 5 );
	
	
	bSizerCreerGaucheMouvements1->Add( bSizerDureeMouvementCreer, 1, wxALIGN_CENTER_HORIZONTAL|wxEXPAND, 5 );
	
	
	sbSizerCreerMouvement->Add( bSizerCreerGaucheMouvements1, 1, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_staticlineCreerMouvements = new wxStaticLine( sbSizerCreerMouvement->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_VERTICAL );
	sbSizerCreerMouvement->Add( m_staticlineCreerMouvements, 0, wxEXPAND | wxALL, 5 );
	
	wxBoxSizer* bSizerCreerDroiteMouvements1;
	bSizerCreerDroiteMouvements1 = new wxBoxSizer( wxVERTICAL );
	
	sbSizerCoordonneesCreerMouvements = new wxStaticBoxSizer( new wxStaticBox( sbSizerCreerMouvement->GetStaticBox(), wxID_ANY, wxT("Coordonnées") ), wxVERTICAL );
	
	bSizerCoordonneesModifierCreer = new wxBoxSizer( wxHORIZONTAL );
	
	
	bSizerCoordonneesModifierCreer->Add( 0, 0, 1, wxEXPAND, 5 );
	
	m_staticTextxCreerMouvements1 = new wxStaticText( sbSizerCoordonneesCreerMouvements->GetStaticBox(), wxID_ANY, wxT("x :"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextxCreerMouvements1->Wrap( -1 );
	bSizerCoordonneesModifierCreer->Add( m_staticTextxCreerMouvements1, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	...
	bSizerCoordonneesModifierCreer->Add( m_textCtrlxCreerMouvements, 1, wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	...
	bSizerCoordonneesModifierCreer->Add( m_staticTextyCreerMouvements, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizerCoordonneesModifierCreer->Add( m_textCtrlyCreerMouvements, 1, wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	...
	bSizerCoordonneesModifierCreer->Add( m_staticTextzCreerMouvements, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizerCoordonneesModifierCreer->Add( m_textCtrlzCreerMouvements, 1, wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	
	
	bSizerCoordonneesModifierCreer->Add( 0, 0, 1, wxEXPAND, 5 );
	
	
	sbSizerCoordonneesCreerMouvements->Add( bSizerCoordonneesModifierCreer, 1, wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALL, 5 );
	
	
	bSizerCreerDroiteMouvements1->Add( sbSizerCoordonneesCreerMouvements, 1, wxALIGN_CENTER_HORIZONTAL|wxEXPAND, 5 );
	
	m_sdbSizerModifierCreer = new wxStdDialogButtonSizer();
	m_sdbSizerModifierCreerSave = new wxButton( sbSizerCreerMouvement->GetStaticBox(), wxID_SAVE );
	m_sdbSizerModifierCreer->AddButton( m_sdbSizerModifierCreerSave );
	m_sdbSizerModifierCreer->Realize();
	
	bSizerCreerDroiteMouvements1->Add( m_sdbSizerModifierCreer, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5 );
	
	
	sbSizerCreerMouvement->Add( bSizerCreerDroiteMouvements1, 1, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 5 );
	
	
	bSizerCreerMouvements->Add( sbSizerCreerMouvement, 1, wxALL|wxEXPAND, 5 );
	...
	m_scrolledWindowDetruireMouvements = new wxScrolledWindow( m_notebookMouvements, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL|wxVSCROLL, wxT("i") );
	m_scrolledWindowDetruireMouvements->SetScrollRate( 5, 5 );
	...
	sbSizerSelectionDetruireMouvements = new wxStaticBoxSizer( new wxStaticBox( m_scrolledWindowDetruireMouvements, wxID_ANY, wxT("Sélection du mouvement à détruire") ), wxHORIZONTAL );
	...
	sbSizerDetruireMouvement = new wxStaticBoxSizer( new wxStaticBox( m_scrolledWindowDetruireMouvements, wxID_ANY, wxT("Affichage") ), wxVERTICAL );
	
	m_staticTextDetruireMouvement = new wxStaticText( sbSizerDetruireMouvement->GetStaticBox(), wxID_ANY, wxT("Êtes-vous sûr de vouloir supprimer ce mouvement ?"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizerDetruireMouvement->Add( 0, 0, 1, wxEXPAND|wxALIGN_CENTER_HORIZONTAL, 5 );
	...
	m_scrolledWindowDetruireMouvements->SetSizer( bSizerDetruireMouvements );
	m_scrolledWindowDetruireMouvements->Layout();
	bSizerDetruireMouvements->Fit( m_scrolledWindowDetruireMouvements );
	m_notebookMouvements->AddPage( m_scrolledWindowDetruireMouvements, wxT("Détruire un mouvement"), false );
	m_scrolledWindowTesterMouvements = new wxScrolledWindow( m_notebookMouvements, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL|wxVSCROLL, wxT("i") );
	m_scrolledWindowTesterMouvements->SetScrollRate( 5, 5 );
	...
	sbSizerSelectionTesterMouvements = new wxStaticBoxSizer( new wxStaticBox( m_scrolledWindowTesterMouvements, wxID_ANY, wxT("Sélection du mouvement à détruire") ), wxHORIZONTAL );
	...
	sbSizerTesterMouvement = new wxStaticBoxSizer( new wxStaticBox( m_scrolledWindowTesterMouvements, wxID_ANY, wxT("Affichage") ), wxVERTICAL );
	
	m_staticTextTesterMouvement = new wxStaticText( sbSizerTesterMouvement->GetStaticBox(), wxID_ANY, wxT("Êtes-vous sûr de vouloir supprimer ce mouvement ?"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizerTesterMouvement->Add( 0, 0, 1, wxEXPAND|wxALIGN_CENTER_HORIZONTAL, 5 );
	...
	m_scrolledWindowTesterMouvements->SetSizer( bSizerTesterMouvements );
	m_scrolledWindowTesterMouvements->Layout();
	bSizerTesterMouvements->Fit( m_scrolledWindowTesterMouvements );
	m_notebookMouvements->AddPage( m_scrolledWindowTesterMouvements, wxT("TEST"), false );
	
	bSizerPrincipal->Add( m_notebookMouvements, 1, wxALIGN_CENTER_HORIZONTAL|wxALL|wxEXPAND, 5 );
	...
	m_listBoxAffichageProcessus->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( FramePrincipal::OnListBoxAffichageSelectionProcessus ), NULL, this );
	m_listBoxAffichageProcessus->Connect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( FramePrincipal::OnListBoxAffichageSelectionProcessus ), NULL, this );
	...
	m_listBoxModifierProcessus->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( FramePrincipal::OnListBoxModifierSelectionProcessus ), NULL, this );
	m_listBoxModifierProcessus->Connect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( FramePrincipal::OnListBoxModifierSelectionProcessus ), NULL, this );
	...
	m_listBoxDetruireProcessus->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( FramePrincipal::OnListBoxDetruireSelectionProcessus ), NULL, this );
	m_listBoxDetruireProcessus->Connect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( FramePrincipal::OnListBoxDetruireSelectionProcessus ), NULL, this );
	...
	m_listBoxLancerProcessus->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( FramePrincipal::OnListBoxLancerSelectionProcessus ), NULL, this );
	m_listBoxLancerProcessus->Connect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( FramePrincipal::OnListBoxLancerSelectionProcessus ), NULL, this );
	...
	m_listBoxTesterProcessus->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( FramePrincipal::OnListBoxTesterSelectionProcessus ), NULL, this );
	m_listBoxTesterProcessus->Connect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( FramePrincipal::OnListBoxTesterSelectionProcessus ), NULL, this );
	...
	m_notebookMouvements->Connect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_listBoxAffichageMouvements->Connect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	...
	m_staticTextNomAfficherMouvements->Connect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_staticTextDureeHeureAfficherMouvements1->Connect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_staticTextDureeMinuteAfficherMouvements->Connect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_staticTextDureeSecondeAfficherMouvements->Connect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_listBoxModifierMouvements->Connect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	...
	m_staticTextNomModifierMouvements->Connect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_staticTextDureeHeureModifierMouvements->Connect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_staticTextDureeMinuteModifierMouvement->Connect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_staticTextDureeSecondeModifierMouvements->Connect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_sdbSizerModifierMouvementApply->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( FramePrincipal::OnApplyButtonModifierMouvementClick ), NULL, this );
	m_sdbSizerModifierMouvementCancel->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( FramePrincipal::OnCancelButtonModifierMouvementClick ), NULL, this );
	m_staticTextNomCreerMouvements->Connect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_staticTextDureeHeureCreerMouvements->Connect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_staticTextDureeMinuteCreerMouvement->Connect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_staticTextDureeSecondeCreerMouvements->Connect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_sdbSizerModifierCreerSave->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( FramePrincipal::OnSaveButtonCreerMouvementClick ), NULL, this );
...
FramePrincipal::~FramePrincipal()
{
	...
	m_listBoxAffichageProcessus->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( FramePrincipal::OnListBoxAffichageSelectionProcessus ), NULL, this );
	m_listBoxAffichageProcessus->Disconnect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( FramePrincipal::OnListBoxAffichageSelectionProcessus ), NULL, this );
	...
	m_listBoxModifierProcessus->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( FramePrincipal::OnListBoxModifierSelectionProcessus ), NULL, this );
	m_listBoxModifierProcessus->Disconnect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( FramePrincipal::OnListBoxModifierSelectionProcessus ), NULL, this );
	...
	m_listBoxDetruireProcessus->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( FramePrincipal::OnListBoxDetruireSelectionProcessus ), NULL, this );
	m_listBoxDetruireProcessus->Disconnect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( FramePrincipal::OnListBoxDetruireSelectionProcessus ), NULL, this );
	...
	m_listBoxLancerProcessus->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( FramePrincipal::OnListBoxLancerSelectionProcessus ), NULL, this );
	m_listBoxLancerProcessus->Disconnect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( FramePrincipal::OnListBoxLancerSelectionProcessus ), NULL, this );
	...
	m_listBoxTesterProcessus->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( FramePrincipal::OnListBoxTesterSelectionProcessus ), NULL, this );
	m_listBoxTesterProcessus->Disconnect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( FramePrincipal::OnListBoxTesterSelectionProcessus ), NULL, this );
	...
	m_notebookMouvements->Disconnect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_listBoxAffichageMouvements->Disconnect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	...
	m_staticTextNomAfficherMouvements->Disconnect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_staticTextDureeHeureAfficherMouvements1->Disconnect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_staticTextDureeMinuteAfficherMouvements->Disconnect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_staticTextDureeSecondeAfficherMouvements->Disconnect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_listBoxModifierMouvements->Disconnect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	...
	m_staticTextNomModifierMouvements->Disconnect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_staticTextDureeHeureModifierMouvements->Disconnect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_staticTextDureeMinuteModifierMouvement->Disconnect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_staticTextDureeSecondeModifierMouvements->Disconnect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_sdbSizerModifierMouvementApply->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( FramePrincipal::OnApplyButtonModifierMouvementClick ), NULL, this );
	m_sdbSizerModifierMouvementCancel->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( FramePrincipal::OnCancelButtonModifierMouvementClick ), NULL, this );
	m_staticTextNomCreerMouvements->Disconnect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_staticTextDureeHeureCreerMouvements->Disconnect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_staticTextDureeMinuteCreerMouvement->Disconnect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_staticTextDureeSecondeCreerMouvements->Disconnect( wxEVT_CHAR, wxKeyEventHandler( FramePrincipal::OnCharEntered ), NULL, this );
	m_sdbSizerModifierCreerSave->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( FramePrincipal::OnSaveButtonCreerMouvementClick ), NULL, this );

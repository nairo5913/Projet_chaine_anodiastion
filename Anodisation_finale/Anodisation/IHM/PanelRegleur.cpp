...
PanelRegleur::PanelRegleur( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	wxBoxSizer* bSizerRegleur;
	bSizerRegleur = new wxBoxSizer( wxVERTICAL );
	...
	sbSizerSelectionAfficherMouvements = new wxStaticBoxSizer( new wxStaticBox( m_scrolledWindowAffichageMouvements, wxID_ANY, wxT("Sélection du mouvement à afficher") ), wxHORIZONTAL );
	...
	m_textCtrlDureeHeureAfficherMouvements = new wxTextCtrl( sbSizerAfficher->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 130,-1 ), wxTE_CENTRE|wxTE_READONLY );
	...
	m_textCtrlDureeMinuteAfficherMouvements = new wxTextCtrl( sbSizerAfficher->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 130,-1 ), wxTE_CENTRE|wxTE_READONLY );
	...
	m_textCtrlDureeSecondeAfficherMouvements = new wxTextCtrl( sbSizerAfficher->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 130,-1 ), wxTE_CENTRE|wxTE_READONLY );
	...
	sbSizerSelectionModifierMouvements = new wxStaticBoxSizer( new wxStaticBox( m_scrolledWindowModifierMouvements, wxID_ANY, wxT("Sélection du mouvement à modifier") ), wxHORIZONTAL );
	...
	m_textCtrlDureeHeureCreerMouvements = new wxTextCtrl( sbSizerCreer->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 130,-1 ), wxTE_CENTRE );
	...
	m_textCtrlDureeMinutesCreerMouvements = new wxTextCtrl( sbSizerCreer->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 130,-1 ), wxTE_CENTRE );
	...
	m_textCtrlDureeSecondeCreerMouvements = new wxTextCtrl( sbSizerCreer->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 130,-1 ), wxTE_CENTRE );
	...
	sbSizerSelectionDetruireMouvements = new wxStaticBoxSizer( new wxStaticBox( m_scrolledWindowDetruireMouvements1, wxID_ANY, wxT("Sélection du mouvement à détruire") ), wxHORIZONTAL );
	...
	m_staticTextDetruireMouvement = new wxStaticText( sbSizerDetruire->GetStaticBox(), wxID_ANY, wxT("Êtes-vous sûr de vouloir supprimer ce mouvement ?"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizerSelectionTesterMouvements = new wxStaticBoxSizer( new wxStaticBox( m_scrolledWindowDetruireMouvements11, wxID_ANY, wxT("Séléction du mouvement à tester") ), wxHORIZONTAL );
	...
	m_staticTextTesterMouvement = new wxStaticText( sbSizerTester->GetStaticBox(), wxID_ANY, wxT("Êtes-vous sûr de vouloir lancer ce test ?"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	bSizerRegleur->Add( m_notebookMouvements, 1, wxEXPAND|wxALL|wxALIGN_CENTER_HORIZONTAL, 5 );
	...
	sbSizerSelectionAfficherTrajectoires = new wxStaticBoxSizer( new wxStaticBox( m_scrolledWindowAffichageTrajectoires, wxID_ANY, wxT("Sélection de la trajectoires à afficher") ), wxHORIZONTAL );
	...
	#ifdef __WXGTK__
	if ( !m_textCtrlBaindedepartAfficher->HasFlag( wxTE_MULTILINE ) )
	{
	m_textCtrlBaindedepartAfficher->SetMaxLength( 100 );
	}
	#else
	m_textCtrlBaindedepartAfficher->SetMaxLength( 100 );
	#endif
	...
	#ifdef __WXGTK__
	if ( !m_textCtrlBainDarriveeAfficher->HasFlag( wxTE_MULTILINE ) )
	{
	m_textCtrlBainDarriveeAfficher->SetMaxLength( 100 );
	}
	#else
	m_textCtrlBainDarriveeAfficher->SetMaxLength( 100 );
	#endif
	...
	sbSizerSelectionModifierMouvements1 = new wxStaticBoxSizer( new wxStaticBox( m_scrolledWindowModifierTrajectoires, wxID_ANY, wxT("Sélection de la trajectoire à modifier") ), wxHORIZONTAL );
	...
	#ifdef __WXGTK__
	if ( !m_textCtrlBainDeDepartModifier->HasFlag( wxTE_MULTILINE ) )
	{
	m_textCtrlBainDeDepartModifier->SetMaxLength( 100 );
	}
	#else
	m_textCtrlBainDeDepartModifier->SetMaxLength( 100 );
	#endif
	...
	#ifdef __WXGTK__
	if ( !m_textCtrlBainDarriveeModifier->HasFlag( wxTE_MULTILINE ) )
	{
	m_textCtrlBainDarriveeModifier->SetMaxLength( 100 );
	}
	#else
	m_textCtrlBainDarriveeModifier->SetMaxLength( 100 );
	#endif
	...
	#ifdef __WXGTK__
	if ( !m_textCtrlDepartTrajectoireCreation->HasFlag( wxTE_MULTILINE ) )
	{
	m_textCtrlDepartTrajectoireCreation->SetMaxLength( 100 );
	}
	#else
	m_textCtrlDepartTrajectoireCreation->SetMaxLength( 100 );
	#endif
	...
	#ifdef __WXGTK__
	if ( !m_textCtrlAriveeTrajectoireCreation->HasFlag( wxTE_MULTILINE ) )
	{
	m_textCtrlAriveeTrajectoireCreation->SetMaxLength( 100 );
	}
	#else
	m_textCtrlAriveeTrajectoireCreation->SetMaxLength( 100 );
	#endif
	...
	sbSizerSelectionDetruireTrajectoires = new wxStaticBoxSizer( new wxStaticBox( m_scrolledWindowDetruireTrajectoires, wxID_ANY, wxT("Sélection de la trajectoire à détruire") ), wxHORIZONTAL );
	...
	m_staticTextDetruireTrajectoires = new wxStaticText( sbSizerDetruireTrajectoires->GetStaticBox(), wxID_ANY, wxT("Êtes-vous sûr de vouloir supprimer cette trajectoire ?"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizerSelectionTesterTrajectoires = new wxStaticBoxSizer( new wxStaticBox( m_scrolledWindowTestTrajectoires, wxID_ANY, wxT("Sélection de la trajectoire à tester") ), wxHORIZONTAL );
	...
	m_staticTextTesterTrajectoires = new wxStaticText( sbSizerTesterTrajectoires->GetStaticBox(), wxID_ANY, wxT("Êtes-vous sûr de vouloir lancer ce test ?"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	bSizerRegleur->Add( m_notebookTrajectoires, 1, wxEXPAND|wxALL|wxALIGN_CENTER_HORIZONTAL, 5 );
	
	
	this->SetSizer( bSizerRegleur );
	this->Layout();
	bSizerRegleur->Fit( this );
	
	// Connect Events
	m_listBoxAffichageMouvements->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelRegleur::OnListBoxAffichageSelectionMouvements ), NULL, this );
	m_listBoxAffichageMouvements->Connect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelRegleur::OnListBoxAffichageSelectionMouvements ), NULL, this );
	m_listBoxModifierMouvements->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelRegleur::OnListBoxModifierSelectionMouvements ), NULL, this );
	m_listBoxModifierMouvements->Connect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelRegleur::OnListBoxModifierSelectionMouvements ), NULL, this );
	m_sdbSizer6Apply->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnApplyButtonModifierMouvementClick ), NULL, this );
	m_sdbSizer6Cancel->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnCancelButtonModifierMouvementClick ), NULL, this );
	m_sdbSizer61Save->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnSaveButtonCreerMouvementClick ), NULL, this );
	m_listBoxDetruireMouvements->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelRegleur::OnListBoxDetruireSelectionMouvements ), NULL, this );
	m_listBoxDetruireMouvements->Connect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelRegleur::OnListBoxDetruireSelectionMouvements ), NULL, this );
	m_sdbSizerDetruireMouvementYes->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnYesButtonDetruireMouvementClick ), NULL, this );
	m_listBoxTesterMouvements->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelRegleur::OnListBoxTesterSelectionMouvements ), NULL, this );
	m_listBoxTesterMouvements->Connect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelRegleur::OnListBoxTesterSelectionMouvements ), NULL, this );
	m_sdbSizerTesterMouvementCancel->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnCancelButtonTestMouvementClick ), NULL, this );
	m_sdbSizerTesterMouvementHelp->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnInfoBrasTestMouvementClick ), NULL, this );
	m_sdbSizerTesterMouvementYes->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnYesButtonTesterMouvementClick ), NULL, this );
	m_listBoxAffichageTrajectoires->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelRegleur::OnListBoxAffichageSelectionTrajectoires ), NULL, this );
	m_listBoxAffichageTrajectoires->Connect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelRegleur::OnListBoxAffichageSelectionTrajectoires ), NULL, this );
	m_listBoxModifierTrajectoires->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelRegleur::OnListBoxModifierSelectionTrajectoires ), NULL, this );
	m_listBoxModifierTrajectoires->Connect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelRegleur::OnListBoxModifierSelectionTrajectoires ), NULL, this );
	m_sdbSizerModifierTrajectoiresApply->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnApplyButtonModifierTrajectoiresClick ), NULL, this );
	m_sdbSizerModifierTrajectoiresCancel->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnCancelButtonModifierTrajectoiresClick ), NULL, this );
	m_listBoxCreerTrajectoires->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelRegleur::OnListBoxSelectionMouvementsCreationTrajectoire ), NULL, this );
	m_sdbSizerCreerTrajectoiresSave->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnSaveButtonCreerTrajectoiresClick ), NULL, this );
	m_listBoxDetruireTrajectoires->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelRegleur::OnListBoxDetruireSelectionTrajectoires ), NULL, this );
	m_listBoxDetruireTrajectoires->Connect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelRegleur::OnListBoxDetruireSelectionTrajectoires ), NULL, this );
	m_sdbSizerDetruireTrajectoiresYes->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnYesButtonDetruireTrajectoiresClick ), NULL, this );
	m_listBoxTesterTrajectoires->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelRegleur::OnListBoxTesterSelectionTrajectoires ), NULL, this );
	m_listBoxTesterTrajectoires->Connect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelRegleur::OnListBoxTesterSelectionTrajectoires ), NULL, this );
	m_sdbSizerTesterTrajectoiresCancel->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnCancelButtonTestTrajectoireClick ), NULL, this );
	m_sdbSizerTesterTrajectoiresHelp->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnInfoBrasTestTrajectoireClick ), NULL, this );
	m_sdbSizerTesterTrajectoiresYes->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnYesButtonTesterTrajectoiresClick ), NULL, this );
}

PanelRegleur::~PanelRegleur()
{
	// Disconnect Events
	m_listBoxAffichageMouvements->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelRegleur::OnListBoxAffichageSelectionMouvements ), NULL, this );
	m_listBoxAffichageMouvements->Disconnect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelRegleur::OnListBoxAffichageSelectionMouvements ), NULL, this );
	m_listBoxModifierMouvements->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelRegleur::OnListBoxModifierSelectionMouvements ), NULL, this );
	m_listBoxModifierMouvements->Disconnect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelRegleur::OnListBoxModifierSelectionMouvements ), NULL, this );
	m_sdbSizer6Apply->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnApplyButtonModifierMouvementClick ), NULL, this );
	m_sdbSizer6Cancel->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnCancelButtonModifierMouvementClick ), NULL, this );
	m_sdbSizer61Save->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnSaveButtonCreerMouvementClick ), NULL, this );
	m_listBoxDetruireMouvements->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelRegleur::OnListBoxDetruireSelectionMouvements ), NULL, this );
	m_listBoxDetruireMouvements->Disconnect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelRegleur::OnListBoxDetruireSelectionMouvements ), NULL, this );
	m_sdbSizerDetruireMouvementYes->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnYesButtonDetruireMouvementClick ), NULL, this );
	m_listBoxTesterMouvements->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelRegleur::OnListBoxTesterSelectionMouvements ), NULL, this );
	m_listBoxTesterMouvements->Disconnect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelRegleur::OnListBoxTesterSelectionMouvements ), NULL, this );
	m_sdbSizerTesterMouvementCancel->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnCancelButtonTestMouvementClick ), NULL, this );
	m_sdbSizerTesterMouvementHelp->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnInfoBrasTestMouvementClick ), NULL, this );
	m_sdbSizerTesterMouvementYes->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnYesButtonTesterMouvementClick ), NULL, this );
	m_listBoxAffichageTrajectoires->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelRegleur::OnListBoxAffichageSelectionTrajectoires ), NULL, this );
	m_listBoxAffichageTrajectoires->Disconnect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelRegleur::OnListBoxAffichageSelectionTrajectoires ), NULL, this );
	m_listBoxModifierTrajectoires->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelRegleur::OnListBoxModifierSelectionTrajectoires ), NULL, this );
	m_listBoxModifierTrajectoires->Disconnect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelRegleur::OnListBoxModifierSelectionTrajectoires ), NULL, this );
	m_sdbSizerModifierTrajectoiresApply->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnApplyButtonModifierTrajectoiresClick ), NULL, this );
	m_sdbSizerModifierTrajectoiresCancel->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnCancelButtonModifierTrajectoiresClick ), NULL, this );
	m_listBoxCreerTrajectoires->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelRegleur::OnListBoxSelectionMouvementsCreationTrajectoire ), NULL, this );
	m_sdbSizerCreerTrajectoiresSave->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnSaveButtonCreerTrajectoiresClick ), NULL, this );
	m_listBoxDetruireTrajectoires->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelRegleur::OnListBoxDetruireSelectionTrajectoires ), NULL, this );
	m_listBoxDetruireTrajectoires->Disconnect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelRegleur::OnListBoxDetruireSelectionTrajectoires ), NULL, this );
	m_sdbSizerDetruireTrajectoiresYes->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnYesButtonDetruireTrajectoiresClick ), NULL, this );
	m_listBoxTesterTrajectoires->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelRegleur::OnListBoxTesterSelectionTrajectoires ), NULL, this );
	m_listBoxTesterTrajectoires->Disconnect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelRegleur::OnListBoxTesterSelectionTrajectoires ), NULL, this );
	m_sdbSizerTesterTrajectoiresCancel->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnCancelButtonTestTrajectoireClick ), NULL, this );
	m_sdbSizerTesterTrajectoiresHelp->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnInfoBrasTestTrajectoireClick ), NULL, this );
	m_sdbSizerTesterTrajectoiresYes->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelRegleur::OnYesButtonTesterTrajectoiresClick ), NULL, this );

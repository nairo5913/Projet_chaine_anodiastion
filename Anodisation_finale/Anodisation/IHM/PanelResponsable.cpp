...
PanelResponsable::PanelResponsable( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	wxBoxSizer* bSizerResponsable;
	bSizerResponsable = new wxBoxSizer( wxVERTICAL );
	...
	m_textCtrlNomAfficher = new wxTextCtrl( sbSizerAfficher->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER|wxTE_READONLY );
	#ifdef __WXGTK__
	...
	m_textCtrlOrdreTrajectoiresAfficher = new wxTextCtrl( sbSizerAfficher->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER|wxTE_READONLY );
	#ifdef __WXGTK__
	...
	m_textCtrlAfficherHeureBain1 = new wxTextCtrl( sbSizerGestionBainAfficher->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER|wxTE_READONLY );
	#ifdef __WXGTK__
	...
	m_textCtrlAfficherMinuteBain1 = new wxTextCtrl( sbSizerGestionBainAfficher->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER|wxTE_READONLY );
	#ifdef __WXGTK__
	...
	m_textCtrlAfficherSecondeBain1 = new wxTextCtrl( sbSizerGestionBainAfficher->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER|wxTE_READONLY );
	#ifdef __WXGTK__
	...
	m_textCtrlAfficherHeureBain2 = new wxTextCtrl( sbSizerGestionBainAfficher->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER|wxTE_READONLY );
	#ifdef __WXGTK__
	...
	m_textCtrlAfficherMinuteBain2 = new wxTextCtrl( sbSizerGestionBainAfficher->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER|wxTE_READONLY );
	#ifdef __WXGTK__
	...
	m_textCtrlAfficherSecondeBain2 = new wxTextCtrl( sbSizerGestionBainAfficher->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER|wxTE_READONLY );
	#ifdef __WXGTK__
	...
	m_textCtrlAfficherHeureBain3 = new wxTextCtrl( sbSizerGestionBainAfficher->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER|wxTE_READONLY );
	#ifdef __WXGTK__
	...
	m_textCtrlAfficherMinuteBain3 = new wxTextCtrl( sbSizerGestionBainAfficher->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER|wxTE_READONLY );
	#ifdef __WXGTK__
	...
	m_textCtrlAfficherSecondeBain3 = new wxTextCtrl( sbSizerGestionBainAfficher->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER|wxTE_READONLY );
	#ifdef __WXGTK__
	...
	m_textCtrlDureeTotalHeureModifier = new wxTextCtrl( sbSizerModifier->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER );
	#ifdef __WXGTK__
	...
	m_textCtrlDureeTotalMinuteModifier = new wxTextCtrl( sbSizerModifier->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER );
	#ifdef __WXGTK__
	...
	m_textCtrlDureeTotalSecondeModifier = new wxTextCtrl( sbSizerModifier->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER );
	#ifdef __WXGTK__
	...
	m_textCtrlNomModifier = new wxTextCtrl( sbSizerModifier->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER );
	#ifdef __WXGTK__
	...
	m_textCtrlOrdreTrajectoiresModifier = new wxTextCtrl( sbSizerModifier->GetStaticBox(), wxID_ORDRE_MODIFIER, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER );
	#ifdef __WXGTK__
	...
	m_textCtrlModifierHeureBain1 = new wxTextCtrl( sbSizerGestionBainModifier->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER );
	#ifdef __WXGTK__
	...
	m_textCtrlModifierMinuteBain1 = new wxTextCtrl( sbSizerGestionBainModifier->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER );
	#ifdef __WXGTK__
	...
	m_textCtrlModifierSecondeBain1 = new wxTextCtrl( sbSizerGestionBainModifier->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER );
	#ifdef __WXGTK__
	...
	m_textCtrlModifierHeureBain2 = new wxTextCtrl( sbSizerGestionBainModifier->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER );
	#ifdef __WXGTK__
	...
	m_textCtrlModifierMinuteBain2 = new wxTextCtrl( sbSizerGestionBainModifier->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER );
	#ifdef __WXGTK__
	...
	m_textCtrlModifierSecondeBain2 = new wxTextCtrl( sbSizerGestionBainModifier->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER );
	#ifdef __WXGTK__
	...
	m_textCtrlModifierHeureBain3 = new wxTextCtrl( sbSizerGestionBainModifier->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER );
	#ifdef __WXGTK__
	...
	m_textCtrlModifierMinuteBain3 = new wxTextCtrl( sbSizerGestionBainModifier->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER );
	#ifdef __WXGTK__
	...
	m_textCtrlModifierSecondeBain3 = new wxTextCtrl( sbSizerGestionBainModifier->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER );
	#ifdef __WXGTK__
	...
	m_textCtrlDureeTotalHeureCreer = new wxTextCtrl( sbSizerCreer->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER );
	#ifdef __WXGTK__
	...
	m_textCtrlDureeTotalMinuteCreer = new wxTextCtrl( sbSizerCreer->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER );
	#ifdef __WXGTK__
	...
	m_textCtrlDureeTotalSecondeCreer = new wxTextCtrl( sbSizerCreer->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER );
	#ifdef __WXGTK__
	...
	m_textCtrlOrdreTrajectoiresCreer = new wxTextCtrl( sbSizerCreer->GetStaticBox(), wxID_ORDRE_CREER, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_PROCESS_ENTER );
	#ifdef __WXGTK__
	...
	m_staticTextDetuireTitre = new wxStaticText( sbSizerDetruire->GetStaticBox(), wxID_ANY, wxT("Processus 0"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticTextTesterTitre = new wxStaticText( sbSizerTester->GetStaticBox(), wxID_ANY, wxT("Processus 0"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	bSizerResponsable->Add( m_notebookProcessus, 1, wxEXPAND|wxALL|wxALIGN_CENTER_HORIZONTAL, 5 );
	
	
	this->SetSizer( bSizerResponsable );
	this->Layout();
	bSizerResponsable->Fit( this );
	
	// Connect Events
	m_notebookProcessus->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_scrolledWindowAffichageProcessus->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_listBoxAffichageProcessus->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_listBoxAffichageProcessus->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelResponsable::OnListBoxAffichageSelection ), NULL, this );
	m_listBoxAffichageProcessus->Connect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelResponsable::OnListBoxAffichageSelection ), NULL, this );
	m_staticTextIdAfficher->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlIdAfficher->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_staticDureeTotalAfficher->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlDureeTotalHeureAfficher->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlDureeTotalHeureAfficher->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_staticTextDureeTotalMinuteAfficher->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlDureeTotalMinuteAfficher->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlDureeTotalMinuteAfficher->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_staticTextDureeTotalSecondeAfficher->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlDureeTotalSecondeAfficher->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlDureeTotalSecondeAfficher->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_listBoxListeTrajectoiresAfficher->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_staticTextNomAfficher->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlNomAfficher->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlNomAfficher->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_staticTextOrdreTrajectoiresAfficher->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlOrdreTrajectoiresAfficher->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlOrdreTrajectoiresAfficher->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_staticTextNombreBainAfficher->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlNombreBainAfficher->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlNombreBainAfficher->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlAfficherHeureBain1->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlAfficherHeureBain1->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlAfficherMinuteBain1->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlAfficherMinuteBain1->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlAfficherSecondeBain1->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlAfficherSecondeBain1->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlAfficherHeureBain2->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlAfficherHeureBain2->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlAfficherMinuteBain2->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlAfficherMinuteBain2->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlAfficherSecondeBain2->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlAfficherSecondeBain2->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlAfficherHeureBain3->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlAfficherHeureBain3->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlAfficherMinuteBain3->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlAfficherMinuteBain3->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlAfficherSecondeBain3->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlAfficherSecondeBain3->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_scrolledWindowModifierProcessus->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_listBoxModifierProcessus->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelResponsable::OnListBoxModifierSelection ), NULL, this );
	m_listBoxModifierProcessus->Connect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelResponsable::OnListBoxModifierSelection ), NULL, this );
	m_textCtrlDureeTotalHeureModifier->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlDureeTotalHeureModifier->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlDureeTotalHeureModifier->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlDureeTotalMinuteModifier->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlDureeTotalMinuteModifier->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlDureeTotalMinuteModifier->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlDureeTotalSecondeModifier->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlDureeTotalSecondeModifier->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlDureeTotalSecondeModifier->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlNomModifier->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlNomModifier->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlOrdreTrajectoiresModifier->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredOrdre ), NULL, this );
	m_textCtrlOrdreTrajectoiresModifier->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlOrdreTrajectoiresModifier->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_spinCtrlNombreBainModifier->Connect( wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler( PanelResponsable::OnSpinCtrlModifierBain ), NULL, this );
	m_textCtrlModifierHeureBain1->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlModifierHeureBain1->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlModifierHeureBain1->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlModifierMinuteBain1->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlModifierMinuteBain1->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlModifierMinuteBain1->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlModifierSecondeBain1->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlModifierSecondeBain1->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlModifierSecondeBain1->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlModifierHeureBain2->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlModifierHeureBain2->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlModifierHeureBain2->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlModifierMinuteBain2->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlModifierMinuteBain2->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlModifierMinuteBain2->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlModifierSecondeBain2->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlModifierSecondeBain2->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlModifierSecondeBain2->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlModifierHeureBain3->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlModifierHeureBain3->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlModifierHeureBain3->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlModifierMinuteBain3->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlModifierMinuteBain3->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlModifierMinuteBain3->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlModifierSecondeBain3->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlModifierSecondeBain3->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlModifierSecondeBain3->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_sdbSizerModifierApply->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_sdbSizerModifierCancel->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelResponsable::OnCancelButtonModiffierClick ), NULL, this );
	m_scrolledWindowCreerProcessus->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlDureeTotalHeureCreer->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlDureeTotalHeureCreer->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlDureeTotalHeureCreer->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlDureeTotalMinuteCreer->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlDureeTotalMinuteCreer->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlDureeTotalMinuteCreer->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlDureeTotalSecondeCreer->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlDureeTotalSecondeCreer->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlDureeTotalSecondeCreer->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlOrdreTrajectoiresCreer->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredOrdre ), NULL, this );
	m_textCtrlOrdreTrajectoiresCreer->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlOrdreTrajectoiresCreer->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlNomCreer->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlNomCreer->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_spinCtrlNombreBainCreer->Connect( wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler( PanelResponsable::OnSpinCtrlCreerBain ), NULL, this );
	m_textCtrlCreerHeureBain1->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlCreerHeureBain1->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlCreerHeureBain1->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlCreerMinuteBain1->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlCreerMinuteBain1->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlCreerMinuteBain1->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlCreerSecondeBain1->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlCreerSecondeBain1->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlCreerSecondeBain1->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlCreerHeureBain2->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlCreerHeureBain2->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlCreerHeureBain2->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlCreerMinuteBain2->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlCreerMinuteBain2->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlCreerMinuteBain2->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlCreerSecondeBain2->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlCreerSecondeBain2->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlCreerSecondeBain2->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlCreerHeureBain3->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlCreerHeureBain3->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlCreerHeureBain3->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlCreerMinuteBain3->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlCreerMinuteBain3->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlCreerMinuteBain3->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlCreerSecondeBain3->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlCreerSecondeBain3->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlCreerSecondeBain3->Connect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_sdbSizerCreerCancel->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelResponsable::OnCancelButtonCreerClick ), NULL, this );
	m_sdbSizerCreerSave->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_scrolledWindowDetruireProcessus->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_listBoxDetruireProcessus->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelResponsable::OnListBoxDetruireSelection ), NULL, this );
	m_listBoxDetruireProcessus->Connect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelResponsable::OnListBoxDetruireSelection ), NULL, this );
	m_sdbSizerDetruireApply->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelResponsable::OnApplyButtonDetruireClick ), NULL, this );
	m_scrolledWindowLancerProcessus->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_listBoxLancerProcessus->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelResponsable::OnListBoxLancerSelection ), NULL, this );
	m_listBoxLancerProcessus->Connect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelResponsable::OnListBoxLancerSelection ), NULL, this );
	m_sdbSizerLancerProcessusOK->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelResponsable::OnOkButtonLancerClick ), NULL, this );
	m_scrolledWindowTesterProcessus->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_listBoxTesterProcessus->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelResponsable::OnListBoxTesterSelection ), NULL, this );
	m_listBoxTesterProcessus->Connect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelResponsable::OnListBoxTesterSelection ), NULL, this );
	m_bpButtonStopTester->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelResponsable::OnStopButtonTesterClick ), NULL, this );
	m_bpButtonOKTester->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelResponsable::OnOkButtonTesterClick ), NULL, this );
	m_scrolledWindowInfoBras->Connect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_buttonDisponibiliteBras->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelResponsable::OnButtonDisponibiliteBrasClick ), NULL, this );
	m_buttonTacheEnCours->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelResponsable::OnButtonTacheEnCoursClick ), NULL, this );
}

PanelResponsable::~PanelResponsable()
{
	// Disconnect Events
	m_notebookProcessus->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_scrolledWindowAffichageProcessus->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_listBoxAffichageProcessus->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_listBoxAffichageProcessus->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelResponsable::OnListBoxAffichageSelection ), NULL, this );
	m_listBoxAffichageProcessus->Disconnect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelResponsable::OnListBoxAffichageSelection ), NULL, this );
	m_staticTextIdAfficher->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlIdAfficher->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_staticDureeTotalAfficher->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlDureeTotalHeureAfficher->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlDureeTotalHeureAfficher->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_staticTextDureeTotalMinuteAfficher->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlDureeTotalMinuteAfficher->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlDureeTotalMinuteAfficher->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_staticTextDureeTotalSecondeAfficher->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlDureeTotalSecondeAfficher->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlDureeTotalSecondeAfficher->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_listBoxListeTrajectoiresAfficher->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_staticTextNomAfficher->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlNomAfficher->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlNomAfficher->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_staticTextOrdreTrajectoiresAfficher->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlOrdreTrajectoiresAfficher->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlOrdreTrajectoiresAfficher->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_staticTextNombreBainAfficher->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlNombreBainAfficher->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlNombreBainAfficher->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlAfficherHeureBain1->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlAfficherHeureBain1->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlAfficherMinuteBain1->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlAfficherMinuteBain1->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlAfficherSecondeBain1->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlAfficherSecondeBain1->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlAfficherHeureBain2->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlAfficherHeureBain2->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlAfficherMinuteBain2->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlAfficherMinuteBain2->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlAfficherSecondeBain2->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlAfficherSecondeBain2->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlAfficherHeureBain3->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlAfficherHeureBain3->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlAfficherMinuteBain3->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlAfficherMinuteBain3->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlAfficherSecondeBain3->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlAfficherSecondeBain3->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_scrolledWindowModifierProcessus->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_listBoxModifierProcessus->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelResponsable::OnListBoxModifierSelection ), NULL, this );
	m_listBoxModifierProcessus->Disconnect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelResponsable::OnListBoxModifierSelection ), NULL, this );
	m_textCtrlDureeTotalHeureModifier->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlDureeTotalHeureModifier->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlDureeTotalHeureModifier->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlDureeTotalMinuteModifier->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlDureeTotalMinuteModifier->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlDureeTotalMinuteModifier->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlDureeTotalSecondeModifier->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlDureeTotalSecondeModifier->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlDureeTotalSecondeModifier->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlNomModifier->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlNomModifier->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlOrdreTrajectoiresModifier->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredOrdre ), NULL, this );
	m_textCtrlOrdreTrajectoiresModifier->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlOrdreTrajectoiresModifier->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_spinCtrlNombreBainModifier->Disconnect( wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler( PanelResponsable::OnSpinCtrlModifierBain ), NULL, this );
	m_textCtrlModifierHeureBain1->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlModifierHeureBain1->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlModifierHeureBain1->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlModifierMinuteBain1->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlModifierMinuteBain1->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlModifierMinuteBain1->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlModifierSecondeBain1->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlModifierSecondeBain1->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlModifierSecondeBain1->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlModifierHeureBain2->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlModifierHeureBain2->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlModifierHeureBain2->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlModifierMinuteBain2->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlModifierMinuteBain2->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlModifierMinuteBain2->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlModifierSecondeBain2->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlModifierSecondeBain2->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlModifierSecondeBain2->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlModifierHeureBain3->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlModifierHeureBain3->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlModifierHeureBain3->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlModifierMinuteBain3->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlModifierMinuteBain3->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlModifierMinuteBain3->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlModifierSecondeBain3->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlModifierSecondeBain3->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_textCtrlModifierSecondeBain3->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_sdbSizerModifierApply->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelResponsable::OnApplyButtonModifierClick ), NULL, this );
	m_sdbSizerModifierCancel->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelResponsable::OnCancelButtonModiffierClick ), NULL, this );
	m_scrolledWindowCreerProcessus->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_textCtrlDureeTotalHeureCreer->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlDureeTotalHeureCreer->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlDureeTotalHeureCreer->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlDureeTotalMinuteCreer->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlDureeTotalMinuteCreer->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlDureeTotalMinuteCreer->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlDureeTotalSecondeCreer->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlDureeTotalSecondeCreer->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlDureeTotalSecondeCreer->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlOrdreTrajectoiresCreer->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredOrdre ), NULL, this );
	m_textCtrlOrdreTrajectoiresCreer->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlOrdreTrajectoiresCreer->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlNomCreer->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlNomCreer->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_spinCtrlNombreBainCreer->Disconnect( wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler( PanelResponsable::OnSpinCtrlCreerBain ), NULL, this );
	m_textCtrlCreerHeureBain1->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlCreerHeureBain1->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlCreerHeureBain1->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlCreerMinuteBain1->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlCreerMinuteBain1->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlCreerMinuteBain1->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlCreerSecondeBain1->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlCreerSecondeBain1->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlCreerSecondeBain1->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlCreerHeureBain2->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlCreerHeureBain2->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlCreerHeureBain2->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlCreerMinuteBain2->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlCreerMinuteBain2->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlCreerMinuteBain2->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlCreerSecondeBain2->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlCreerSecondeBain2->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlCreerSecondeBain2->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlCreerHeureBain3->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlCreerHeureBain3->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlCreerHeureBain3->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlCreerMinuteBain3->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlCreerMinuteBain3->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlCreerMinuteBain3->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_textCtrlCreerSecondeBain3->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEnteredNum ), NULL, this );
	m_textCtrlCreerSecondeBain3->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_textCtrlCreerSecondeBain3->Disconnect( wxEVT_COMMAND_TEXT_MAXLEN, wxCommandEventHandler( PanelResponsable::OnTextMaxLength ), NULL, this );
	m_sdbSizerCreerCancel->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelResponsable::OnCancelButtonCreerClick ), NULL, this );
	m_sdbSizerCreerSave->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelResponsable::OnSaveButtonCreerClick ), NULL, this );
	m_scrolledWindowDetruireProcessus->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_listBoxDetruireProcessus->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelResponsable::OnListBoxDetruireSelection ), NULL, this );
	m_listBoxDetruireProcessus->Disconnect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelResponsable::OnListBoxDetruireSelection ), NULL, this );
	m_sdbSizerDetruireApply->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelResponsable::OnApplyButtonDetruireClick ), NULL, this );
	m_scrolledWindowLancerProcessus->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_listBoxLancerProcessus->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelResponsable::OnListBoxLancerSelection ), NULL, this );
	m_listBoxLancerProcessus->Disconnect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelResponsable::OnListBoxLancerSelection ), NULL, this );
	m_sdbSizerLancerProcessusOK->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelResponsable::OnOkButtonLancerClick ), NULL, this );
	m_scrolledWindowTesterProcessus->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_listBoxTesterProcessus->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( PanelResponsable::OnListBoxTesterSelection ), NULL, this );
	m_listBoxTesterProcessus->Disconnect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( PanelResponsable::OnListBoxTesterSelection ), NULL, this );
	m_bpButtonStopTester->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelResponsable::OnStopButtonTesterClick ), NULL, this );
	m_bpButtonOKTester->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelResponsable::OnOkButtonTesterClick ), NULL, this );
	m_scrolledWindowInfoBras->Disconnect( wxEVT_CHAR, wxKeyEventHandler( PanelResponsable::OnCharEntered ), NULL, this );
	m_buttonDisponibiliteBras->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelResponsable::OnButtonDisponibiliteBrasClick ), NULL, this );
	m_buttonTacheEnCours->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( PanelResponsable::OnButtonTacheEnCoursClick ), NULL, this );

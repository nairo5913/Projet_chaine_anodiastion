...
{
	this->SetSizeHints( wxSize( 500,200 ), wxSize( 1024,770 ) );
	...
	m_textCtrlSaisieRequete = new wxTextCtrl( sbSizerSaisieRequete->GetStaticBox(), wxID_ANY, wxT("SELECT * FROM "), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizerSaisieRequete->Add( m_textCtrlSaisieRequete, 0, wxALIGN_CENTER|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 5 );
	...
	bSizer2->Add( m_buttonExecutionRequete, 0, wxALIGN_BOTTOM|wxALL, 5 );
	
	
	sbSizerSaisieRequete->Add( bSizer2, 1, wxALIGN_CENTER_HORIZONTAL, 5 );
	
	
	bSizerPrincipal->Add( sbSizerSaisieRequete, 1, wxEXPAND, 5 );
	...
	sbSizerResultat->Add( m_textCtrlResultat, 1, wxALIGN_CENTER|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 5 );
	
	
	bSizerPrincipal->Add( sbSizerResultat, 2, wxEXPAND, 5 );
